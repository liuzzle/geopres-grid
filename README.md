...
| `LiquidAI/LFM2.5-Embedding-350M` | none documented | model card + release blog, checked 15.09.2026 |
| `microsoft/harrier-oss-v1-270m` | none documented | model card + Foundry/Bing posts, checked 15.09.2026 |
| `microsoft/harrier-oss-v1-0.6b` | none documented | model card + Foundry/Bing posts, checked 15.09.2026 |

So an MRL comparison across both MRL backbones is legitimate at **128, 256 and 512**.
For the other three, truncation is a naive baseline, not a zero-overhead DR method.
